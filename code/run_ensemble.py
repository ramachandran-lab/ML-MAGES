...
def main():
    ...
    for i_trait, trait in enumerate(traits):
        ...
        ml_mages.plot_enrichment(df_enrich, fig_file, level=0.05)
    end_time = time.time()
